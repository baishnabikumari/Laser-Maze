...
# Real-Time physics
**Laser calculates the path instantly as you move the mirror or splitter.**
...
# Levels?
> **There are 10 levels currently... More soon.**
> **All levels are handcrafted using ASCII tiles**
> **The level contains the below objects**
```bash
Mirror(/, \\)
Splitter(%)
```
...
# Installation?
> **No need to INSTALL something this game run on browser!.**

* **Do this Instead**
1. Clone repo
```bash
  git clone https://github.com/baishnabikumari/Laser-Maze.git
```
